...
const UsersListTab = () => {
  ...
  return (
    <Container maxWidth="lg" sx={{py: 4}}>
      ...
      // Search box: при натискане на Enter — refresh, при промяна — setSearch (debounced В hook)
      <TextField
        size="small"
        placeholder="Търси по имейл..."
        value={params.search || ''}
        onChange={e => {
          setSearch (e.target.value); // debounce може да е включен
        }}
        onKeyDown={e => {
          if (e.key === 'Enter') {
            // прави незабавно търсене при Enter
            refresh ();
          }
        }}
