...
const UploadForm = () => {
  ...
  return (
    ...
    >
      ...
      {uploadedFileUrl && (
        <p className="mt-2 text-blue-600 font-medium text-center">
          Файлът е достъпен на: <a href={uploadedFileUrl} target="_blank" rel="noopener noreferrer">{uploadedFileUrl}</a>
        </p>
      )}
      {error && (
