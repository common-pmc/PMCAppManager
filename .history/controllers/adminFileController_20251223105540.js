...
exports.getAllFiles = async (req, res) => {
  try {
    ...
    // Build final where so paginate receives the correct filter directly by company
    ...
    const companyInclude = {
      ...
      required: !!v, // INNER JOIN при търсене => филтриране на редовете
      where: v ? where (fn ('LOWER', col ('Company.companyName'))) : undefined,
    };

    const finalWhere = v ? {...baseWhere, ...companyInclude} : baseWhere;

    console.log ('[getAllFiles] finalWhere:', finalWhere);
